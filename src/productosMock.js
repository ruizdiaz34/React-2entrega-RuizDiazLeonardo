const products = [
        ...
        { id: "3", name: "Banana", img: "https://media.justo.mx/products/12637-Manzana_Roja.jpg", price: 100, category: "fruta", description: "madura", stock: 20 },
        { id: "4", name: "Manzana", img: "https://images.immediate.co.uk/production/volatile/sites/30/2017/01/Bunch-of-bananas-67e91d5.jpg", price: 120, category: "fruta", description: "roja", stock: 20 },
    ...
    export const getProducts = () => { 
        ...
        return new Promise( (resolve, reject) => { 
            if(products.length > 0) {
                ...
                reject("No hay productos, vaya a comprar a otro lado")
            }
        } )
     }